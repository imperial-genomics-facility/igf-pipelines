...
sub resource_classes {
    ...
    return {
            ...
            '2GbDebug' => { 'PBSPro' => '-q '.$self->o('pbs_queue').'-m e -M '.$self->o('user_email').' -l walltime=24:00:00 -l select=1:ncpus=1:mem=2gb:tmpspace=50gb' },
            ...
            '4GbDebug' => { 'PBSPro' => '-q '.$self->o('pbs_queue').'-m e -M '.$self->o('user_email').' -l walltime=24:00:00 -l select=1:ncpus=1:mem=4gb:tmpspace=100gb' },
